...
class CreateCourseFormComponent(BaseComponent):
    def __init__(self, page: Page):
        ...
        self.title_input = Input(page, 'create-course-form-title-input', name='Title input')
        self.estimated_time_input = Input(
            page, 'create-course-form-estimated-time-input', name='Estimated time input'
        )
        self.description_textarea = (
            Textarea(page, 'create-course-form-description-input', name='Description textarea')
        )
        self.max_score_input = Input(page, 'create-course-form-max-score-input', name='Max score input')
        self.min_score_input = Input(page, 'create-course-form-min-score-input', name='Min score input')
